				...
				<GridItem xs={12} sm={6} md={4}>
					<Card>
						<CardHeader color="warning" stats icon>
							...
							<h3 className={classes.cardTitle}>Tally</h3>
						</CardHeader>
						<CardFooter stats>
							<div className={classes.stats}>
								<LocalOffer />
					...
					<Card>
						...
						<CardBody>
							<Table
								...
								tableHead={["Name", "Phone", "Course", "Description"]}
								tableData={[
									[
										"Purva Narsing",
										"9936272836",
										"Tally",
										"Want to complete in one month.",
									],
									[
										"Mansi Nandwana",
										"9568902211",
									...
									["Jeel Patel", "8735248639", "Basic", ""],
									[
										"Vidhi Sharma",
										"9936438373",
										"English",
										"Can read write but cant speak.",
									],
									[
										"Manuni Mistry",
										"89363838373",
